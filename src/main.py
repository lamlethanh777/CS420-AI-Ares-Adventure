...
class SokobanVisualizer(QWidget):
    ...
    def load_images(self):
        ...
        self.wall_image_orig = QPixmap("asset/wall.png")
        self.incorrect_box_image_orig = QPixmap("asset/incorrect_box.png")
        self.correct_box_image_orig = QPixmap("asset/correct_box.png")
        self.goal_image_orig = QPixmap("asset/goal.png")
        self.floor_image_orig = QPixmap("asset/floor.png")
        self.player_images_orig = {
            "u": QPixmap("asset/player_up.png"),
            "d": QPixmap("asset/player_down.png"),
            "l": QPixmap("asset/player_left.png"),
            "r": QPixmap("asset/player_right.png"),
        }
        self.rescale_images()
...
class App(QWidget):
    ...
    def update_map(self):
        ...
        new_map_file = os.path.join(INPUT_FOLDER, map_file)
    ...
    def update_map_dropdown(self):
        ...
        input_files = [
            f for f in os.listdir(INPUT_FOLDER) if f.endswith(".txt") and "input" in f
        ]
